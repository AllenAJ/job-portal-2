<?php
require_once('php/admin_user_fetch.php');
...
/* $cust_id=$_GET['custid'];
 */
$sql = "SELECT * FROM tbl_login WHERE email='$cust_id'";
...
<!--                 <li class="nav-item">
    ...
    <div class="card">
      ...
      <form action='php/admin_user_update.php' method='POST'>
        ...
        <label>Email</label>
			  	<input style="pointer-events:none;" type="email" class="form-control" value="<?php echo $cust_id ?>" name="email" >
        </div>    
        <div class="form-group">
        ...
        <label>User Type</label>
			  	<input type="text" class="form-control" value="<?php echo $usertype ?>" name="usertype">
        </div>   
    <div class="form-group">
        <label>Phone no</label>
			  	<input type="text" class="form-control" value="<?php echo $phoneno ?>" name="phoneno">
        </div>  
        ...
        <?php
                            ...
                            {
                            ?>
        <form action='php/admin_user_remove.php?custid=<?php echo $cust_id ?>' method='POST'>
        ...
        <?php
                            ...
                            {
                            ?>
        <form action='php/admin_user_remove2.php?custid=<?php echo $cust_id ?>' method='POST'>
